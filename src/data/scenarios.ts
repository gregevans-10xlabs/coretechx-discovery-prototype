...
export const PERSONAS = [
  ...
  { id:"maya",     label:"Maya",     title:"Service Officer",                      region:"National",             types:["starlink","hn","jbhifi","insurance","construction","fm"],      canConfig:true,  configAccess:"drafter"    as ConfigAccessTier },
  { id:"mei",      label:"Mei",      title:"Finance Officer",                      region:"National",             types:["starlink","hn","jbhifi","insurance","construction","fm"],      canConfig:true,  configAccess:"drafter"    as ConfigAccessTier },
