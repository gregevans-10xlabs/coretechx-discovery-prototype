...
export const BUSINESS_OUTCOMES: BusinessOutcome[] = [
  ...
  },
  {
    ...
    phase: "phase_1",
    primaryValue: "0",
    primaryLabel: "Notifiable incidents (28d)",
    secondary: [
      { label: "FS audits this month",     value: "26 of 40" },
      { label: "WHS observations logged",  value: "138" },
    ],
    trend: { direction: "flat", detail: "Stable — no incidents in 6 weeks", good: true },
    breakdownByRegion: [
      { label: "North East NSW", value: "Audit 14/20 (Troy) · 1 flagged" },
      { label: "South NSW",      value: "Audit 12/20 (Kylie) · 0 flagged" },
      { label: "QLD",            value: "Audit (none scheduled)" },
    ],
    drillDown: "1 site flagged this week (Penrith — re-attendance pending Logan sign-off). No notifiable incidents this period.",
  },
  {
    id: "O-compliance",
    category: "compliance",
